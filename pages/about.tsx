    ...
    <div className="app">
      ...
      <main className="main">
        ...
        <div className="promotional-message">
          <h3>About</h3>
          <h2>Our Story</h2>
          <p> We were founded in the greatest century of our time by James Elle.
              He's a super active nutrtist , personal trainer and entreprenuer 
              he's created a <strong>exclusive selection of meal plans</strong> available for everyone.</p>
